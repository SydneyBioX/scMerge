...
Under most circumstances, `scMerge` is fast enough to be used on a personal laptop for a moderately large data. For example, a single run of `scMerge` on the full mESC data with 24224 features and 704 cells takes roughly 40 seconds.  
