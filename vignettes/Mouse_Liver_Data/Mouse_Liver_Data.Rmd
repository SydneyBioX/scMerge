...
In addition to normalising across 4 scRNA-Seq datasets, this `scMerge` normalisation across 4 different dataset lead to a novel result: In the face of incomplete data, `scMerge` revealed cell trajectories of hepatoblasts, hepatocytes and cholangiocytes more consistent with the full Liver data collection and agrees with current literature. 
